...
public class Utils {
  ...
  public static LogicalPlan indexScan(String tableName, Expression filter) {
    return PrometheusLogicalIndexScan.builder().relationName(tableName).filter(filter).build();
  }
  ...
  public static LogicalPlan indexScan(String tableName,
    ...
    return PrometheusLogicalIndexScan.builder().relationName(tableName)
  ...
  public static LogicalPlan indexScan(String tableName,
    ...
    return PrometheusLogicalIndexScan.builder()
  ...
  public static LogicalPlan indexScanAgg(String tableName, List<NamedAggregator> aggregators,
    ...
    return PrometheusLogicalIndexAgg.builder().relationName(tableName)
  ...
  public static LogicalPlan indexScanAgg(String tableName,
                                         ...
                                         List<NamedExpression> groupByList) {
    return PrometheusLogicalIndexAgg.builder().relationName(tableName).filter(filter)
        .aggregatorList(aggregators).groupByList(groupByList).build();
  }
