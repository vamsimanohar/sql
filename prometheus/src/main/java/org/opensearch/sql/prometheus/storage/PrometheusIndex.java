...
public class PrometheusIndex implements Table {
   ...
   * Constructor.
   */
  public PrometheusIndex(PrometheusClient prometheusService, String indexName) {
  ...
  public PhysicalPlan implement(LogicalPlan plan) {
    PrometheusMetricScan indexScan = new PrometheusMetricScan( prometheusService, indexName,
