...
import org.opensearch.sql.prometheus.client.OpenSearchClient;
import org.opensearch.sql.prometheus.request.system.OpenSearchCatIndicesRequest;
import org.opensearch.sql.prometheus.request.system.PrometheusDescribeMetricRequest;
import org.opensearch.sql.prometheus.request.system.OpenSearchSystemRequest;
  ...
  private Pair<OpenSearchSystemIndexSchema, OpenSearchSystemRequest> buildIndexBundle(
    ...
    if (systemTable.isSystemInfoTable()) {
      ...
      return Pair.of(OpenSearchSystemIndexSchema.SYS_TABLE_MAPPINGS,
          new PrometheusDescribeMetricRequest(null, systemTable.getTableName()));
    }
  }
}
