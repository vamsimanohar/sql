...
public class MergeSortAndIndexAgg implements Rule<LogicalSort> {
  ...
  private final Capture<PrometheusLogicalIndexAgg> indexAggCapture;
  ...
  public MergeSortAndIndexAgg() {
    ...
    this.pattern = typeOf(LogicalSort.class)
        ...
        .with(source().matching(typeOf(PrometheusLogicalIndexAgg.class)
  ...
  public LogicalPlan apply(LogicalSort sort,
                           Captures captures) {
    PrometheusLogicalIndexAgg indexAgg = captures.get(indexAggCapture);
    return PrometheusLogicalIndexAgg.builder()
  ...
  private boolean hasAggregatorInSortBy(LogicalSort sort, PrometheusLogicalIndexAgg agg) {
