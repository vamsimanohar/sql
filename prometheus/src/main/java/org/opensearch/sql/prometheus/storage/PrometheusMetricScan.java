...
public class PrometheusMetricScan extends TableScanOperator {
  ...
  public PrometheusMetricScan(PrometheusClient prometheusService,
    ...
    this(prometheusService, new OpenSearchRequest.IndexName(indexName), exprValueFactory);
  }

  /**
   * Constructor.
   */
  public PrometheusMetricScan(PrometheusClient prometheusService, OpenSearchRequest.IndexName indexName,
                              OpenSearchExprValueFactory exprValueFactory) {
    this.prometheusService = prometheusService;
    this.request = new OpenSearchQueryRequest(indexName, exprValueFactory);
  }
