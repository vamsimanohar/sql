...
public class WorkUnit {
  ...
  public static WorkUnit createScanUnit(
      String workUnitId, DataPartition dataPartition, String assignedNodeId) {
    return new WorkUnit(
        workUnitId,
        WorkUnitType.SCAN,
        dataPartition,
   ...
   */
  public static WorkUnit createProcessUnit(String workUnitId, List<String> dependencies) {
    return new WorkUnit(
        workUnitId,
   ...
   */
  public static WorkUnit createFinalizeUnit(String workUnitId, List<String> dependencies) {
    return new WorkUnit(
        workUnitId,
