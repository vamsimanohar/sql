...
/**
 * Core operator interface inspired by Trino's push/pull model. Operators form a pipeline where data
 * flows as {@link Page} batches. Each operator declares whether it needs input ({@link
 * #needsInput()}), accepts input ({@link #addInput(Page)}), and produces output ({@link
 * #getOutput()}).
 *
 * <p>Lifecycle:
 *
