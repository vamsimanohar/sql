...
import org.opensearch.sql.plugin.catalog.PPLCatalogService;
import org.opensearch.sql.plugin.catalog.PPLCatalogSettings;
...
public class SQLPlugin extends Plugin implements ActionPlugin, ScriptPlugin, ReloadablePlugin {
  ...
  private PPLCatalogService pplCatalogService;
  ...
  public List<RestHandler> getRestHandlers(Settings settings, RestController restController,
    ...
    return Arrays.asList(
        new RestPPLQueryAction(restController, clusterService, pluginSettings, settings, pplCatalogService),
  ...
  public Collection<Object> createComponents(Client client, ClusterService clusterService,
    ...
    this.pplCatalogService = new PPLCatalogService(clusterService.getSettings());
  ...
  public List<Setting<?>> getSettings() {
    return new ImmutableList.Builder<Setting<?>>()
        ...
        .add(PPLCatalogSettings.CATALOG_CONFIG)
        .add(PPLCatalogSettings.FEDERATION_ENABLED)
        .build();
  }
  ...
  public void reload(Settings settings) {
    this.pplCatalogService.loadConnectors(settings);
  }
